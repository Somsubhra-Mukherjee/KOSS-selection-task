...
var _heavy = Module['_heavy'] = makeInvalidEarlyAccess('_heavy');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['heavy'] != 'undefined', 'missing Wasm export: heavy');
  ...
  _heavy = Module['_heavy'] = createExportWrapper('heavy', 1);
